...
const Student = () => {
  ...
  const handleStudentOpenExcelForm = async () => {
  ...
  const handleCloseStudentExcelForm = () => {
    setIsFormExcelOpen(false);
    setStudent(null);
  };
    ...
    >
      ...
      >
        ...
        <CommonButton
          ...
          onClick={handleStudentOpenExcelForm}
          size="large"
        >
          Thêm danh sách mới
        </CommonButton>
